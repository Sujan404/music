...
__webpack_require__(/*! ./googlePlaceApi */ "./resources/js/googlePlaceApi.js");
...
/***/ "./resources/js/googlePlaceApi.js":
/*!****************************************!*\
  !*** ./resources/js/googlePlaceApi.js ***!
  \****************************************/
/***/ (() => {
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      switch (componentType) {
        case "subpremise":
          {
            console.log("****************************");
            unitNumberField.value = "".concat(component.short_name);
            console.log("This is subpremise: ", unitNumberField.value);
          }
        case "street_number":
          {
            streetNumberField.value = "".concat(component.short_name);
        ...
        case "postal_code":
          {
            postalField.value = "".concat(component.long_name).concat(postalField.value);
