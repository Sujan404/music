   <!--google api -->
   <script async
   src="https://maps.googleapis.com/maps/api/js?key={{env('GOOGLE_MAPS_API')}}&callback=initAutocomplete&libraries=places&v=weekly"
   defer
 ></script>
<title>Music | Admin Profile</title>
<div>
    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            ...
            <div class="card card-body border-0 shadow mb-4">
                ...
                <form wire:submit.prevent="update" method="POST" action="{{route("profile.update")}}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="user.last_name" class="form-control" id="last_name" type="text"
                                    placeholder="Also your last name" value="{{ auth()->user()->last_name }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input wire:model="user.email" class="form-control" id="email" type="email"
                                    placeholder="name@company.com" value="{{ auth()->user()->email }}" disabled>
                            </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <div class="form-group">
                                {{-- // need to work in unit number and street number
                                // for example: 1/15 Olympic Drive, Lidcombe NSW 2141
                                // for example: 7/32 Hampstead Rd, Homebush West 2140 --}}
                                <label for="search_address">Search address</label> 
                                <input wire:model="user.address" class="form-control" id="search_address" type="text"
                                    placeholder="Enter your address">
                            </div>
                            @error('user.search_address') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-sm-9 mb-3" hidden>
                            <div id="map"></div>
                        </div> 
                    </div>
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input wire:model="user.unit" class="form-control" id="unit" type="text"
                                    placeholder="Unit">
                            </div>
                            @error('user.unit') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                        ...
                        <div class="col mb-3">
                            <div class="form-group">
                                ...
                                <input wire:model="user.street_name" class="form-control" id="street_name" type="text"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input wire:model="user.state" class="form-control" id="state" type="text"
                                    placeholder="State">
                            </div>
                            @error('user.state') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input wire:model="user.postal_code" class="form-control" id="postal_code" type="text" placeholder="Postal code">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input wire:model="user.country" class="form-control" id="country" type="text" placeholder="Country">
                            </div>
                        </div>
                        @error('user.country') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mt-3">
